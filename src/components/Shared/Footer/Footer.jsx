        ...
        <div className="grid space-y-4 space-x-4 grid-cols-1 md:grid-cols-3">
          ...
          >
            <h2 className="text-white text-3xl font-bold font-grandHotel tracking-widest">
              <span className="text-teal-600">Wellness  </span>Merchandise-Shop
            </h2>
            <p>
              Join with us through facebook and instagram or subscribe to our newsletter to get update from us about our new products. Stay Stylish with wellness Merchandise Shop.
            </p>
          ...
          <div data-aos="fade-left" data-aos-duration="1500" className="">
            ...
            <p>
              Join us to be updated about all the products information's that are available in WELLNESS-MERCHANDISE-SHOP🌟
            </p>
        ...
        >
          <p className="text-gray-200 text-sm">
            ...
            <span className="text-white text-sm font-bold">
              <span className="text-teal-600">Wellness </span>Shop
            </span>
            <br />
            Developed by <AiFillHeart className="inline text-orange" /> Wellness-center
          </p>
