  ...
  return (
    <div className="w-2/3 flex flex-col items-center justify-center mx-auto  h-full py-10">
      ...
      <h3 className="text-2xl text-red-500">
        For the payment please contact to wellness center. Pay there and get you product. You can also contact to this Number +60196570474(whatsApp) with the screen shot of the product to know details. <br /> Thank you😊💐
      </h3>
    </div>
  );
};
